...
添加集成软件包
`cfdisk, htop, openssl-util, kmod-fuse, kmod-usb-net-ipheth, kmod-usb-net-rndis, luci-app-adguardhome, luci-app-ddns-go, luci-app-frps, luci-app-argon-config, luci-app-autoreboot, luci-app-diskman, luci-app-ksmbd, luci-app-nlbwmon, luci-app-ttyd, luci-app-upnp, luci-app-usb-printer, luci-app-zerotier, luci-app-ttyd, luci-app-wol, luci-theme-argon`
等并预置 openclash 内核
